...
public class PhotoPhotoGraphyImpl implements IPhotoPhotoGraphy{
	...
	@Override
	public void addPhoto(PhotoPhotoGraphy photophotography) {
		// TODO Auto-generated method stub
		try {
			photophotographyMapper.insert(photophotography);
	...
	@Override
	public void deletePhotoGraphy(String Photoid) {
		// TODO Auto-generated method stub
		try {
			photophotographyMapper.deleteByPrimaryKey(Photoid);
