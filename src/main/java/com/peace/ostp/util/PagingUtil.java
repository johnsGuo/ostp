...
public class PagingUtil {
	...
	public static String getPageBtnlink(int currentPageNo, int maxPageNo) {
		...
		if (maxPageNo > 1) {
			...
			bf.append(currentPageNo==1?("<li class=\"disabled\"><a>首页</a></li>"):("<li><a class=\""+ "pagebutton\"" +" data-id = \"" + 1 + "\">"+"首页"+"</a></li>"));
			bf.append(currentPageNo > 1 ? ("<li><a class=\""+ "pagebutton\"" +" data-id = \"" + (currentPageNo - 1 > 1 ? currentPageNo - 1 : 1) + "\" >上一页</a></li>") : "<li class=\"disabled\"><a>上一页</a></li>");
			for (int i = begainNo; i <= endNo; i++) {

				if (i == currentPageNo) {

					bf.append("<li class=\"active\"><a class=\""+ "pagebutton\"" +" data-id = \"" + i + "\">" + i + "</a></li>");
				} else
					bf.append("<li><a class=\""+ "pagebutton\"" +" data-id = \"" + i + "\" >" + i
							+ "</a></li>");
			}
			bf.append(currentPageNo < maxPageNo ? ("<li><a class=\""+ "pagebutton\"" +" data-id = \"" + (currentPageNo + 1 > maxPageNo ? maxPageNo : currentPageNo + 1) + "\" >下一页</a></li>") : "<li class=\"disabled\"><a>下一页</a></li>");
			bf.append(currentPageNo==maxPageNo?("<li class=\"disabled\"><a>尾页</a></li>"):("<li><a class=\""+ "pagebutton\"" +" data-id = \"" + (currentPageNo + 1 > maxPageNo ? maxPageNo : currentPageNo + 1) + "\">尾页</a></li>"));
			bf.append("	<li><a>共"+maxPageNo+"页</a></li>\n");
			return bf.toString();
		}
		return "";
	...
	public static void main(String[] args){
		System.out.println(PagingUtil.getPagelink(1,3,"","admin/info"));
	}
