											...
											<div class="row">
												...
												<div class="col-sm-4">
													<div class="form-group">
														...
														<div class="col-sm-9">
															<input name="createtime" type="text" id="form-field-1" placeholder="yyyy-mm-dd HH:mm:ss" class="form-control date-picker date_calendar " required="required" oninvalid="setCustomValidity('请输入发布时间')" value="<fmt:formatDate value='${basicinfo.createtime}' pattern='yyyy-MM-dd HH:mm:ss'/>" oninput="setCustomValidity('')">
														</div>
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														...
														<div class="col-sm-9">
															...
															<input name="photo" type="file" id="form-field-1"  oninvalid="setCustomValidity('请选择相关图片')" oninput="setCustomValidity('')" value="${basicinfo.imgurl }">
														</div>
													</div>
												</div>
											</div>
