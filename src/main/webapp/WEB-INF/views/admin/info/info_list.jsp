															...
															<tr>
																...
																<td>
																	<c:forEach items="${allSecondLevel }" var="secondLevel">
																		<c:if test="${allSecondLevel.secondlevelinfotypeid eq item.secondlevelinfotypeid}">
																			${allSecondLevel.secondlevelinfotypename}
																		</c:if>
																	</c:forEach>
																</td>
																<td>${item.copyfrom}</td>
																	...
																	<div class="visible-xs visible-sm hidden-md hidden-lg">
																		<div class="inline position-relative">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a href="javascript:void(0);" class="tooltip-error delete delete_a" attr-id="${item.infoId}"  data-rel="tooltip" title="Delete">
																						<span class="red">
