                            ...
                            <form id="potography-select" class="clearfix form-actions" action="admin/photography-list" method="POST" enctype="form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                   <c:if test="${photophotography.begintime != null }">
                                                        	<input placeholder="yyyy-MM-dd" id="begin-time" name="begintime" onclick="laydate({istime: false, format: 'YYYY-MM-DD'})" class="laydate-icon form-control date-picker date_calendar" type="text" value="${photophotography.begintime }">
                                                    	</c:if>
                                                    	<c:if test="${photophotography.begintime == null }">
                                                    		<input placeholder="yyyy-MM-dd" id="begin-time" name="begintime" onclick="laydate({istime: false, format: 'YYYY-MM-DD'})" class="laydate-icon form-control date-picker date_calendar" type="text">
                                                    	</c:if>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <!--添加下拉菜单-->
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">照片风格</label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
														<c:if test="${photophotography.endtime != null }">
                                                        	<input placeholder="yyyy-MM-dd" id="end-time" name="endtime" onclick="laydate({istime: false, format: 'YYYY-MM-DD'})" class="laydate-icon form-control date-picker date_calendar" type="text" value="${photophotography.endtime }">
                                                    	</c:if>
                                                    	<c:if test="${photophotography.endtime == null }">
                                                    		<input placeholder="yyyy-MM-dd" id="end-time" name="endtime" onclick="laydate({istime: false, format: 'YYYY-MM-DD'})" class="laydate-icon form-control date-picker date_calendar" type="text">
                                                    	</c:if>
                                                        <span class="input-group-addon">
															<i class="icon-calendar bigger-110"></i>
														</span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <c:choose>
                                            	...
                                            	<input type="text" name="minliketimes" id="form-field-1" placeholder="今日最小点赞数" class="form-control"   value="${photophotography.minliketimes }" oninput="setCustomValidity('')">
                                            	</c:when>
                                            	<c:otherwise>
                                            	<input type="text" name="minliketimes" id="form-field-1" placeholder="今日最小点赞数" class="form-control"   oninput="setCustomValidity('')">
                                            	</c:otherwise>
                                            </c:choose>
                                            </div>
                                             ...
                                             <div class="col-sm-8">
                                               <c:choose>
                                            	<c:when test="${photophotography.maxliketimes != null}">
                                            		<input type="text" name="maxliketimes" placeholder="今日最大点赞数" class="form-control"  value="${photophotography.maxliketimes }" >
                                            	</c:when>
                                            	<c:otherwise>
                                            		<input type="text" name="maxliketimes" id="form-field-1" placeholder="今日最大点赞数" class="form-control" >
                                            	</c:otherwise>
                                            </c:choose>
                                            </div>
                                        </div>
                                      ...
                                      <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">总点赞数</label>
                                            <div class="col-sm-8">
                                               ...
                                               <c:choose>
                                            	...
                                            	<input type="text" name="tminliketimes" id="form-field-1" placeholder="最小点赞数" class="form-control"   value="${photophotography.tminliketimes }" oninput="setCustomValidity('')">
                                            	</c:when>
                                            	<c:otherwise>
                                            	<input type="text" name="tminliketimes" id="form-field-1" placeholder="最小点赞数" class="form-control"   oninput="setCustomValidity('')">
                                            	</c:otherwise>
                                            </c:choose>
                                            </div>
                                             ...
                                             <div class="col-sm-8">
                                               ...
                                               <c:choose>
                                            	...
                                            	<input type="text" name="tmaxliketimes" id="form-field-1" placeholder="最大点赞数" class="form-control"   value="${photophotography.tmaxliketimes }" oninput="setCustomValidity('')">
                                            	</c:when>
                                            	<c:otherwise>
                                            	<input type="text" name="tmaxliketimes" id="form-field-1" placeholder="最大点赞数" class="form-control"   oninput="setCustomValidity('')">
                                            	</c:otherwise>
                                            </c:choose>
                                            </div>
                                        </div>
                                        		...
                                        		<c:when test="${fn:length(photophotographys.results) > 0 }">
                                        			<c:forEach items="${photophotographys.results }" var="photophotography" varStatus="statu">
	                                        			 <tr id="zixun_tr">
				                                            ...
				                                            <td>${photophotography.publishtime}</td>
				                                            <td> 
				                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
				                                                   ...
				                                                   <a class="red" href="admin/photography-del?pictureid=${photophotography.pictureid}&photourl=${photophotography.photourl}"  <%--  attr-id="${photophotography.pictureid }" --%>>
