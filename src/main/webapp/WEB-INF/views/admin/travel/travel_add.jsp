				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="admin/insert" method="post">
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="travelname" id="form-field-1" placeholder="行程名称" required="required" oninvalid="setCustomValidity('请输入行程名称')" class="form-control">
											</div>
										</div>
									</div>
									<div class="col-sm-4">
								...
								<div class="row" style="margin:50px auto 0 auto;width:90%;">
									<!--富文本内容-->
									行程攻略：
									<textarea id="guide_content" class="ckeditor" name="guide" style="margin:0 auto;">请在这里输入行程攻略。。。。。。</textarea>
								...
								<div class="row" style="margin:50px auto 0 auto;width:90%;">
									<!--富文本内容-->
									注意事项：
									<textarea class="ckeditor" name="attention" style="margin:0 auto;"></textarea>
						...
						<!-- 查询 -->
							<div id="posi-left">
								<div id="posi-selcet">
									<form id="position-select" class="clearfix form-actions" action="admin/travel-positions-page" method="post" onsubmit="">
	                                    <div class="row">
	                                        <div class="col-sm-4">
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-sm-9">
	                                                	<input type="text" id="form-field-1" name="positionname"class="form-control">
	                                                </div>
	                                            </div>
	                                        </div>
	                                        <div class="col-sm-4">
	                                    ...
	                                    <div class="row">
	                                        <div class="form-actions">
	                                            <div class="col-sm-offset-5 col-md-3">
	                                            	<input type="button" id="select_posi" class="btn btn-primary" value="查询">
	                                            </div>
	                                        </div>
	                                    </div>
	                                </form>
