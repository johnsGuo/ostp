							...
							<form action="admin/travel-update" method="post">
								<div class="row">
									...
									<div class="row" style="margin:50px auto 0 auto;width:90%;">
										<!--富文本内容-->
										行程攻略
										<textarea class="ckeditor" name="guide" style="margin:0 auto;">${tripTravelInfo.guide }</textarea>
										<script type="text/javascript">var myEditor = CKEDITOR.replace('guide');</script>
									</div>
									<div class="row" style="margin:50px auto 0 auto;width:90%;">
										<!--富文本内容-->
										注意事项
										<textarea class="ckeditor" name="attention" style="margin:0 auto;">${tripTravelInfo.attention }</textarea>
